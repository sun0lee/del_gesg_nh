...
//			20221019 수정 : Smith Wilson 의 추정이 비정상인 경우, 음의 가격 예외처리 위해 주석 
		 // 20230720 수정 : alpha 찾는 로직을 수정하고 여기는 원래대로 (에러가 해결되었는지 확인용)
			spotCont[i] = -1.0 / this.prjYearFrac[i] * Math.log(priceZcb[i]);
...
//		    if (i > 690 && i < 725) { // 23.07.20 에러 구간확인 
//		        System.out.println("priceZcb[" + i + "]: " + priceZcb[i] +" spot "+ spotCont[i]+" fwd "+fwdCont[i]);
//		    }
		}
